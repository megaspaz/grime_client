...
/**
 * <p>Title: GRIME - Generic RPG Instant Messenger Environment</p>
 * <p>Description: Client Interface For GRIME</p>
...
public class frmAbout extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    panel1.setMaximumSize(new Dimension(400, 140));
    panel1.setMinimumSize(new Dimension(400, 140));
    panel1.setPreferredSize(new Dimension(400, 140));
